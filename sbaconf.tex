...
Minas Gerais - Av. Antônio Carlos 6627, 31270-901, Belo Horizonte, MG, Brasil\\ e-mail:charlesqp@ufmg.br.}
    ...
    Os fluídos magneto-reológicos fazem parte da classificação de fluídos controláveis, sua principal característica, quando expostos a uma variação de campo magnético, é a habilidade de transitar do estado líquido viscoso para semissólido em um intervalo de tempo da ordem de  milissegundos como é demonstrado na figura {} abaixo.
    ...
    Na figura \ref{} a seguir é exibida a curva característica de força-velocidade de um amortecedor MR em função da corrente aplicada às bobinas geradoras de campo
